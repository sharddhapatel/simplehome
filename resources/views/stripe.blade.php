...
<div class="container">
    ...
    <center><h1>Add New Detail</h1></center>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{url('addorder')}}" method="post" class="require-validation"
                      ...
                      @if(session('cart'.$user_id))
                        ...
                        <div class="form-group row">
                            ...
                            @foreach($address as $add)
                               <input name="oldadd" id="oldadd"  type="radio" value="{{$add->address}},{{$add->city}},{{$add->zipcode}}"
                               onclick="document.getElementById('form1').style.display='none' " unchecked>
                                {{$add->address}},{{$add->city}},{{$add->zipcode}} <br>
                            @endforeach
                            </div>  
                            </div>
                        ...
                        <button class="btn btn-success btn-sm" type="button" name ="addaddress"  id="addnewaddress" value ="Use Another Address" 
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label'>Name on Card</label> <input
                                    class='form-control' size='4' type='text' name="cardname">
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group card required'>
                                <label class='control-label'>Card Number</label> <input
                                    autocomplete='off' class='form-control card-number' maxlength="20" type='text' name="cardno" id="credit-card">
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            ...
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Month</label> <input
                                    class='form-control card-expiry-month' placeholder='MM' maxlength="2" type='text' name="month">
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Year</label> <input
                                    class='form-control card-expiry-year' placeholder='YYYY' maxlength="4" type='text' name="year">
                            </div>
                        </div>
