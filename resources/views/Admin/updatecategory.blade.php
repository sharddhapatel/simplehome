                ...
                <div class="login-wrap">
                  <div  style="float: left;">
                    ...
                    <div class="login-content">
                      ...
                      <input type="text" class="form-control" placeholder=" Category Name"   value="{{ $data->c_name }}" onkeypress="return checkNum(event)"  name="c_name" id="c_name" ><p id="c_name_validation"></p>
                      </div>
